...
class ObjectTableSceneCfg(TestAssetTableCylinderSceneCfg):
    """G1 Dex1 scene aligned to the GenieSim popcorn base pose."""
...
@configclass
class TestG129DEX1BaseFixEnvCfg(ManagerBasedRLEnvCfg):
    """Test task for validating the GenieSim ICRA popcorn scene assets."""
